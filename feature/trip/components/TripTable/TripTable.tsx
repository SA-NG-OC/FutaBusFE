          ...
          <div className="py-1">
            {statusOptions.map((option) => (
              <div
                ...
                className={`block px-4 py-2 text-sm cursor-pointer hover:bg-[var(--bg-hover)] transition-colors ${
...
const TripTable = ({
  ...
  const formatDate = (dateStr: string) => {
    ...
    return date.toLocaleDateString("vi-VN"); // Chuyển định dạng ngày sang vi-VN
  };
