      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.textContent}>
            <div className={styles.badge}>🎉 Ưu đãi mùa lễ - Giảm đến 20%</div>
            ...
            <p className={styles.description}>
              Hệ thống đặt vé xe khách trực tuyến hiện đại, tiện lợi. Với hơn
              1000+ chuyến xe mỗi ngày, đặt vé nhanh chóng chỉ trong vài phút.
            </p>
          ...
          <div className={styles.imageContent}>
            <div className={styles.busImage}>
              ...
              <div className={styles.placeholder}>🚌 Bus Interior Image</div>
              ...
              <div className={styles.infoCard}>
                ...
                <div>
                  ...
                  <div className={styles.infoText}>
                    Đặt vé không cần thanh toán trước
                  </div>
                </div>
              </div>
            </div>
